...
return [
    ...
    'IP'          => '192.168.1.36',//与服务器接口调用IP地址设置
    'IP1'          => '192.168.1.35',//跳转页面本地址的IP地址
    'db_config2' => 'mysql://admin:admin123456@192.168.1.36:3306/world_back#utf8',//数据库配置
    'nodeCfg' => "节点",
    'numP' => "numP(代表当前节点,需要多少推广玩家)",
    'needProfit' => "needProfit(代表该接点需要给公司产生多少收益)",
    'maxProp' => "maxProp(表示该节点达到了条件 最大分红比例)",
    'name' => "name(改节点的名称)",
    'redType1' => '"redType(分红类型)":"节点分红"',
    'redType2' => '"redType(分红类型)":"公司分红"',
    'maxWithDraw' => "maxWithDraw(每日最大提币限制)",
