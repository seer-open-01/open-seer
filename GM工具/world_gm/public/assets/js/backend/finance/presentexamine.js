define(['jquery', 'bootstrap', 'backend', 'table', 'form'], function ($, undefined, Backend, Table, Form) {
    ...
    var Controller = {
        index: function () {
            ...
            Table.api.init({
                extend: {
                    index_url: 'finance/presentexamine/index',
                    //edit_url: 'finance/presentexamine/edit',
                    //multi_url: 'finance/librarylist/multi',
                    table: 'user_list'
                }
            });
            ...
            table.bootstrapTable({
                ...
                columns: [
                    [
                        ...
                        {field: 'whether1', title: __('是否同意'),operate: 'LIKE'},
                        ...
                        {name: 'detail', text: '审核', title: '审核', classname: 'btn btn-xs btn-primary btn-dialog', url: 'finance/presentexamine/examine', callback:function(data){}}
