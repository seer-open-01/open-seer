define(['jquery', 'bootstrap', 'backend', 'table', 'form'], function ($, undefined, Backend, Table, Form) {
    ...
    var Controller = {
        index: function () {
            ...
            Table.api.init({
                extend: {
                    index_url: 'finance/financiallist/index',
                    table: 'user_list'
                }
            });
            ...
            table.bootstrapTable({
                ...
                columns: [
                    [
                        ...
                        {field: 'whether2', title: __('订单状态'),operate: 'LIKE'},
                        ...
                        {field: 'uid', title: __('操作'), table: table, buttons: [
                            {name: 'detail', text: '处理', title: '财务审核',icon: 'fa fa-pencil', classname: 'btn btn-xs btn-primary btn-dialog', url: 'finance/financiallist/examine', callback:function(data){}}
                        ], operate:false, formatter: Table.api.formatter.buttons},
                        /*{field: 'uid', title: __('操作'), table: table, buttons: [
                         {name: 'detail', text: '处理1', title: '财务审核',icon: 'fa fa-pencil', classname: 'btn btn-xs btn-primary btn-dialog', url: 'finance/financiallist/examine', callback:function(data){}}
                         ], operate:false, formatter: Table.api.formatter.buttons}*/
                    ]
                ],
                showExport: false
