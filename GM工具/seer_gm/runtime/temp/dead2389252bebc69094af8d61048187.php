<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:76:"E:\PHPTutorial\WWW\seer_gm\public/../application/admin\view\index\login.html";i:1544776552;}*/ ?>
                    ...
                    <form action="" method="post" id="login-form">
                        ...
                        <div class="input-group">
                            ...
                            <span class="input-group-addon" style="padding:0;border:none;cursor:pointer;">
                                        <img src="<?php echo rtrim('/seer_gm/public/', '/'); ?>/captcha" width="100" height="30" onclick="this.src = '<?php echo rtrim('/seer_gm/public/', '/'); ?>/captcha?r=' + Math.random();"/>
                                    </span>
                        </div>
                        <?php endif; ?>
