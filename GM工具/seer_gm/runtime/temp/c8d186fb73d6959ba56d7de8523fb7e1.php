<?php if (!defined('THINK_PATH')) exit(); /*a:6:{s:88:"E:\PHPTutorial\WWW\fastadmin_revision1\public/../application/admin\view\index\index.html";i:1535699920;s:78:"E:\PHPTutorial\WWW\fastadmin_revision1\application\admin\view\common\meta.html";i:1535699920;s:80:"E:\PHPTutorial\WWW\fastadmin_revision1\application\admin\view\common\header.html";i:1535699920;s:78:"E:\PHPTutorial\WWW\fastadmin_revision1\application\admin\view\common\menu.html";i:1535699920;s:81:"E:\PHPTutorial\WWW\fastadmin_revision1\application\admin\view\common\control.html";i:1535699920;s:80:"E:\PHPTutorial\WWW\fastadmin_revision1\application\admin\view\common\script.html";i:1535699920;}*/ ?>
<!DOCTYPE html>
...
<a href="javascript:;" class="logo">
    ...
    <!-- 普通模式下Logo -->
    <span class="logo-lg">
        <!--<b><?php echo mb_substr($site['name'],0,4,'utf-8'); ?></b><?php echo mb_substr($site['name'],4,null,'utf-8'); ?>-->
        棋牌管理
    </span>
</a>
    ...
    <div id="firstnav">
        ...
        <div class="navbar-custom-menu">
            <ul class="nav navbar-nav">
                ...
                <li>
                    <a href="/fastadmin_revision1/public/" target="_blank"><i class="fa fa-home" style="font-size:14px;"></i></a>
                </li>
                ...
                <li class="dropdown user user-menu">
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                        <img src="/fastadmin_revision1/public<?php echo $admin['avatar']; ?>" class="user-image" alt="<?php echo $admin['nickname']; ?>">
                        <span class="hidden-xs"><?php echo $admin['nickname']; ?></span>
                    </a>
                    <ul class="dropdown-menu">
                        <!-- User image -->
                        <li class="user-header">
                            <img src="/fastadmin_revision1/public<?php echo $admin['avatar']; ?>" class="img-circle" alt="">
...
<section class="sidebar">
    ...
    <div class="user-panel hidden-xs">
        <div class="pull-left image">
            <a href="general/profile" class="addtabsit"><img src="/fastadmin_revision1/public<?php echo $admin['avatar']; ?>" class="img-circle" /></a>
        </div>
