<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:103:"E:\PHPTutorial\WWW\fastadmin_revision1\public/../application/admin\view\gamemodule\createsc\create.html";i:1568709090;s:81:"E:\PHPTutorial\WWW\fastadmin_revision1\application\admin\view\layout\default.html";i:1535699920;s:78:"E:\PHPTutorial\WWW\fastadmin_revision1\application\admin\view\common\meta.html";i:1535699920;s:80:"E:\PHPTutorial\WWW\fastadmin_revision1\application\admin\view\common\script.html";i:1535699920;}*/ ?>
<!DOCTYPE html>
...
<script type="text/javascript">
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <input class="form-control" placeholder="请输入创建平台描述" id="desc" name="desc">
        </div>
    </div>
    <div class="form-group">
        <label for="c-pid" class="control-label col-xs-12 col-sm-2">保证金:</label>
        <div class="col-xs-12 col-sm-8">
            <input class="form-control" placeholder="请输入保证金" id="guaranty" name="guaranty">
        </div>
    </div>
    <div class="form-group">
        <label class="control-label col-xs-12 col-sm-2"></label>
        <div class="col-xs-12 col-sm-8">
            <button type="button" class="btn btn-success btn-embossed <?php echo $auth->check('gamemodule/createsc/create')?'':'hide'; ?>" id="cha">创建平台</button>
        </div>
    </div>
    <div class="form-group">
        <label class="control-label col-xs-12 col-sm-2"></label>
...
<script type="text/javascript">
    $(function () {
        $("#cha").click(function () {
            ...
            var url = "<?php echo url('createSave'); ?>";
            $.ajax({
                type:"post",
                url:url,
                data:{desc:desc,guaranty:guaranty},
                dataType:"json",
