<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:100:"E:\PHPTutorial\WWW\fastadmin_revision1\public/../application/admin\view\gamemodule\online\index.html";i:1536657531;s:81:"E:\PHPTutorial\WWW\fastadmin_revision1\application\admin\view\layout\default.html";i:1535699920;s:78:"E:\PHPTutorial\WWW\fastadmin_revision1\application\admin\view\common\meta.html";i:1535699920;s:80:"E:\PHPTutorial\WWW\fastadmin_revision1\application\admin\view\common\script.html";i:1535699920;}*/ ?>
<!DOCTYPE html>
...
<body>
    <table class="mytable">
        ...
        <tbody id="tbody">
            <tr>
                <td id="all"><?php echo $all; ?></td>
                <td>
                    <a id="refrea" style="text-decoration:none;cursor: pointer;">刷新</a>
                </td>
            </tr>
        </tbody>
    </table>
...
<!--刷新在线人数-->
<script type="text/javascript">
    $("#refrea").click(function () {
        var url = "<?php echo url('refresh'); ?>";
        $.ajax({
            type:"post",
            url:url,
            data:{},
