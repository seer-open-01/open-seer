<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:94:"E:\PHPTutorial\WWW\fastadmin_revision1\public/../application/common\view\tpl\dispatch_jump.tpl";i:1535699920;}*/ ?>
<!DOCTYPE html>
<html>
<head>
...
<div class="system-message <?php echo $codeText; ?>">
    <div class="image">
        <img src="/fastadmin_revision1/public/assets/img/<?php echo $codeText; ?>.svg" alt="" width="150" />
    </div>
    <h1><?php echo $msg; ?></h1>
    <?php if($url): ?>
        <p class="jump">
    ...
    <?php endif; ?>
    <p class="clearfix">
        <a href="/fastadmin_revision1/public/" class="btn btn-grey"><?php echo __('Go back'); ?></a>
        <?php if($url): ?>
