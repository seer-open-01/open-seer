<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:102:"E:\PHPTutorial\WWW\fastadmin_revision1\public/../application/admin\view\gamemodule\transfer\index.html";i:1568705780;s:81:"E:\PHPTutorial\WWW\fastadmin_revision1\application\admin\view\layout\default.html";i:1535699920;s:78:"E:\PHPTutorial\WWW\fastadmin_revision1\application\admin\view\common\meta.html";i:1535699920;s:80:"E:\PHPTutorial\WWW\fastadmin_revision1\application\admin\view\common\script.html";i:1535699920;}*/ ?>
<!DOCTYPE html>
...
<script type="text/javascript">
    ...
    <div class="form-group">
        <label for="c-pid" class="control-label col-xs-12 col-sm-2">转出账户:</label>
        <div class="col-xs-12 col-sm-8">
            <input class="form-control" placeholder="请输入账号" id="from" name="from">
        </div>
    </div>
    <div class="form-group">
        <label for="c-pid" class="control-label col-xs-12 col-sm-2">转入账户:</label>
        <div class="col-xs-12 col-sm-8">
            <input class="form-control" placeholder="请输入账号" id="to" name="to">
        </div>
    </div>
    <div class="form-group">
        <label for="c-pid" class="control-label col-xs-12 col-sm-2">数量:</label>
        <div class="col-xs-12 col-sm-8">
            <input class="form-control" placeholder="请输入账号" id="num" name="num">
        </div>
    </div>
    <div class="form-group">
        <label class="control-label col-xs-12 col-sm-2"></label>
        <div class="col-xs-12 col-sm-8">
            <button type="button" class="btn btn-success btn-embossed <?php echo $auth->check('gamemodule/transfer/set')?'':'hide'; ?>" id="cha">转出</button>
        </div>
    </div>
    <div class="form-group">
        <label class="control-label col-xs-12 col-sm-2"></label>
