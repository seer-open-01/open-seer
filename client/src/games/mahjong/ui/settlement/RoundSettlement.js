 ...
 */
// 单局结算界面
GameWindowMahjong.RoundSettlement = game.ui.PopupWindow.extend({
    _node               : null,         // 本节点

    _imgTitleWinner     : null,         // 赢标题
    ...
    ctor : function () {
        this._super();
        this._node = ccs.load("res/Games/Mahjong/Settlement/RoundSettlementWindow.json").node;
        this._init();
...
GameWindowMahjong.RoundSettlement._instance = null;

GameWindowMahjong.RoundSettlement.close = function () {
    if (this._instance) {
 ...
 */
GameWindowMahjong.RoundSettlement.popup = function (infoData, nextCallback, shareCallback, leaveCallback) {
    if (this._instance == null) {
        this._instance = new GameWindowMahjong.RoundSettlement();
