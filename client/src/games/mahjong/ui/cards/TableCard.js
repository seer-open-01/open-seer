 ...
 */
// ==== 麻将游戏  桌牌 ==========================================
GameWindowMahjong.TableCard = cc.Class.extend({
    _node           : null,         // 本节点
    ...
    setValue : function (value) {
        ...
        var path = GameWindowMahjong.TableCard.RES_PAHT + gameData.getDirectionString(this._uiIndex)
            + "/" + this._value + ".png";
    ...
    addIndicator : function () {
        ...
        GameWindowMahjong.TableCardIndicator.addToNode(this._sprite, cc.p(size.width * 0.5, size.height * 0.5));
    },
...
GameWindowMahjong.TableCard.RES_PAHT = "res/Games/Mahjong/CardsImages/TableCards/";