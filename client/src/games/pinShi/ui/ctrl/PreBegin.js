 ...
 */
// 游戏开始前按钮
GameWindowPinShi.PreBegin = cc.Class.extend({
    ...
    ctor : function (node) {
        ...
        this._node = ccs.load("res/Games/PinShi/PreBegin/PreBegin.json").node;
    ...
    _init : function () {
        ...
        this._btnReady = game.findUI(this._nd1, "BTN_Ready");
        this._btnChange = game.findUI(this._nd1, "BTN_Change");
        this._labelTime = game.findUI(this._nd1, "ND_Time");
    ...
    startReadyCountDown : function () {
        var actionTimer = game.procedure.PinShi.getGameData().getMainPlayer().actionTimer;
