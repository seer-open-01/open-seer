/**
 * Created by lyndon Mo on 2017/06/27.
 */
// 出牌管理控件
GameWindowDouDiZhu.PlayCardsBtns = cc.Class.extend({
    ...
    ctor : function (node) {
        ...
        this._node = ccs.load("res/Games/DouDiZhu/PlayCardsBtns/PlayCardsBtns.json").node;
        this._init();
