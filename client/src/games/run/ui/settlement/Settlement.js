...
WindowRun.Settlement = cc.Layer.extend({
    ...
    ctor: function () {
        this._super();
        this._node = ccs.load("res/Games/Run/Settlement/SettlementRound.json").node;
    ...
    _init: function () {
        ...
        this._players = [];
        for (var i = 1; i <= 4; ++i) {
            this._players.push(new WindowRun.Settlement.PlayerInfo(game.findUI(ndPlayers, "Player_" + i)));
        }
    ...
    setInfo: function (info) {
        ...
        game.Audio.runPlaySettlementBGM(players[gameData.playerIndex].roundBean >= 0);
...
WindowRun.Settlement._instance = null;

WindowRun.Settlement.close = function () {
    if (this._instance) {
 ...
 */
WindowRun.Settlement.popup = function (info, next_cb) {
    if (this._instance == null) {
        this._instance = new WindowRun.Settlement();
