 ...
 * Author       : lyndon
 * Date         : 2018-07-26
 * Description  : 房卡场加入房间弹窗
 */
game.ui.JoinWindow = game.ui.PopupWindow.extend({
    ...
    ctor: function () {
        this._super();
        this._node = ccs.load("res/RoomCard/Join/JoinWindow.json").node;
        this._init();
    ...
    showRoomId: function () {
        ...
        for (i = 0; i < this._roomId.length; ++i) {
            ...
            this._values[i].setTexture("res/RoomCard/Image/Num_" + this._roomId[i] + ".png");
...
game.ui.JoinWindow.popup = function () {
    var win = new game.ui.JoinWindow();
    game.ui.JoinWindow.inst = win;
