...
PFCMgr.prototype = {
     ...
     */
    initCfg(){
        this.key = Config.PFCAddress[addrConfig.MiddleHost] ? Config.PFCAddress[addrConfig.MiddleHost].key : Config.PFCAddress.test.key;
        this.reqHost = Config.PFCAddress[addrConfig.MiddleHost] ? Config.PFCAddress[addrConfig.MiddleHost].reqHost : Config.PFCAddress.test.reqHost;
...
exports = module.exports = new PFCMgr();
